define(['component/Chart','demo/model/Book','component/Counter','messages'], function (Chart,Book,Counter,messages) {
  ...
  function BookPresenter() {
    ...
    gSobject['init'] = function(it) {
      ...
      return gs.println(gs.gp(gSobject.messages,"salute"));
    }
